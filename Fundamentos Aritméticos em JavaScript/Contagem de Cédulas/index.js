...
var dif = valor
let n100 = parseInt(dif / 100)
if (n100 != 0) {
  dif = dif - 100 * n100
}
let n50 = parseInt(dif / 50)
if (n50 != 0) {
  dif = dif - 50 * n50
}
let n20 = parseInt(dif / 20)
if (n20 != 0) {
  dif = dif - 20 * n20
}
let n10 = parseInt(dif / 10)
if (n10 != 0) {
  dif = dif - 10 * n10
}
let n5 = parseInt(dif / 5)
if (n5 != 0) {
  dif = dif - 5 * n5
}
let n2 = parseInt(dif / 2)
if (n2 != 0) {
  dif = dif - 2 * n2
}
let n1 = parseInt(dif / 1)
if (n1 != 0) {
  dif = dif - 1 * n1
}
console.log(valor)
